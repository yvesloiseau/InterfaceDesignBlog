class UserRegistrationsController < Devise::RegistrationsController
  ...
  def after_sign_up_path_for(articles)
    articles_path #'/articles/path' # Or :prefix_to_your_route
  end
  ...
  def after_update_path_for(articles)
    articles_path #'/articles/path' # Or :prefix_to_your_route
  end

  def after_resource_updated_path_for(articlles)
    articles_path #'/articles/path' # Or :prefix_to_your_route
  end
